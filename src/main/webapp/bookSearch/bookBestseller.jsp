...
<head>
    ...
    <script src="../js/bookBestseller.js"></script>
...
////////////////////////////////////////////////////////////////////
  	...
  	$(function() {
		...
		// 바로 구매 버튼 클릭 이벤트 생성
		  $(document).on('click', '.btn.btn-buy', function() {  
			alert("구매 페이지로 이동합니다.");
    ...
    <header class="header">
   	...
   	<div class="header-container-ham">
        ...
        <nav class="nav-menu">
            ...
            <a href= '<%=request.getContextPath() %>/bookSearch/bookBestseller.jsp' style="font-weight: bold; color: #303030">베스트셀러</a>
