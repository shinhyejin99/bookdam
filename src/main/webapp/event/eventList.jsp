    ...
    <header class="header">
    	...
    	<div class="header-container-ham">
            ...
            <nav class="nav-menu">
                ...
                <a href= '<%=request.getContextPath() %>/EventList.do' style="font-weight: bold; color: #303030">문화/행사</a>
...
<div class="container mt-5">
    <h2 class="section-title">🌈 문화/행사 안내</h2>
    ...
    <div class="event-container">
        ...
        %>
            <div class="event-card">
                <img src="<%= request.getContextPath() %>/images/event/<%= vo.getEventType() %>" alt="행사 이미지" class="mx-auto d-block">
                <div class="event-body">
                    <div class="event-title"><%= vo.getEventTitle() %></div>
                    <div class="event-date">📅 <%= vo.getEventDate().substring(0,10) %></div>
                    <a href="<%= request.getContextPath() %>/EventDetail.do?eventId=<%= vo.getEventId() %>" class="btn btn-sm btn-primary btn-detail">상세보기</a>
                </div>
            </div>
        <%
                }
