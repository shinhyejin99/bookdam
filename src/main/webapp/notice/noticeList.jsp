...
<div class="header-container-ham">
    ...
    <nav class="nav-menu">
		...
		<a href= '<%=request.getContextPath() %>/NoticeList.do' style="font-weight: bold; color: #303030">공지사항</a>
...
<div class="container mt-3" style="max-width: 1100px; min-height: 650px;">
    
<h3 class="mb-4 border-bottom pb-2">📋 공지사항</h3>

	<!-- ✅ 디버깅용 출력 -->
    <table class="table table-hover align-middle" id="list">
        <thead class="table-light">
            <tr>
                <th style="width: 15%; text-align: center;">번호</th>
                <th style="width: 63%;">&nbsp;&nbsp;제목</th>
                <th style="width: 22%; text-align: center;">등록일</th>
            </tr>
        </thead>
        <tbody>
            <c:forEach var="notice" items="${noticeList}">
                <tr>
                    ...
                    <td><a href="<%=request.getContextPath() %>/NoticeDetail.do?noticeId=${notice.noticeId}" class="text-decoration-none">&nbsp;&nbsp;${notice.noticeTitle}</a></td>
